...
describe("Test Class PokemonRepository", () => {
  ...
  it('Test If Method "getPokemonMatrix" Returns Matrix Of Pokemons Data From Service', async () => {
  ...
  it('Test If Method "getPokemon" Returns Pokemon Data From Service', async () => {
    spyOn(axios, "get").and.returnValue(
